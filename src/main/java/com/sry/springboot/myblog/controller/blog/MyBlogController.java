...
import com.sry.springboot.myblog.controller.vo.BlogDetailVO;
...
import com.sry.springboot.myblog.util.*;
...
//    public static String theme = "yummy-jekyll";
    ...
    public String page(HttpServletRequest request, @PathVariable("pageNum") int pageNum) {
        ...
        request.setAttribute("blogPageResult", blogPageResult); //blog详细信息
    ...
    public String detail(HttpServletRequest request,
        ...
        if (blogDetailVO != null) {
            ...
            request.setAttribute("commentPageResult", commentService.getCommentPageByBlogIdAndPageNum(blogId,
                    commentPage));
        }
    ...
    public String search(HttpServletRequest request,
                         ...
                         @PathVariable("page") Integer page) {
        PageResult blogsPageResult = blogService.getBlogsPageBySearch(keyword, page);
        request.setAttribute("blogPageResult", blogsPageResult);
